...
export const Loans = () => {
    ...
    async function renewLoan(bookId: number) {
        const url = `${process.env.REACT_APP_API}/api/books/secure/renew/loan?bookId=${bookId}`;
                    ...
                    <>
                        ...
                        {shelfCurrentLoans.map(shelfCurrentLoan => (
                            <div key={shelfCurrentLoan.book.id}>
                                ...
                                <hr />
                                <LoansModel shelfCurrentLoan={shelfCurrentLoan} mobile={false} 
                    ...
                    <>
                        ...
                        {shelfCurrentLoans.map(shelfCurrentLoan => (
                            <div key={shelfCurrentLoan.book.id}>
                                ...
                                <hr />
                                <LoansModel shelfCurrentLoan={shelfCurrentLoan} mobile={true} 
                                returnBook={returnBook} renewLoan={renewLoan}/>
                            </div>
                        ))}
                    </> :
